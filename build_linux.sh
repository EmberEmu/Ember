...
# GCC is already the default compiler and up-to-date
#####################################################################################################
...
# PCRE is wonky on linux with homebrew
sudo apt-get install -y procps curl file libpcre3-dev

############################################################################################
# Install homebrew and get dependencies through here since it's faster and more up-to-date
############################################################################################
