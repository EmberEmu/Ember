...
TInputStream::TInputStream(const void * pvInBuffer, size_t cbInBuffer)
{
    pbInBufferEnd = (const unsigned char *)pvInBuffer + cbInBuffer;
    pbInBuffer = (const unsigned char *)pvInBuffer;
    BitBuffer = 0;
    BitCount = 0;
}
