...
ASIO is an ***AS***ynchronous ***I/O*** library that primarily deals with networing. 
...
Boost Serialisation allows for easy serialisation/deserialisation of data structures for saving/load to/from disk.
...
Google Test, or gtest, is a unit testing library used for Ember's tests, located in the 'test' directory.
...
MySQLCPP is Oracle's C++ wrapper for its C-based MySQL client library. This library is only used if building the project with MySQL support.
