...
opts::variables_map parse_arguments(const int argc, const char* argv[]) {
	...
	cmdline_opts.add_options()
		...
		("config,c", opts::value<std::string>()->default_value("character.conf"),
	...
	//Config file options
	opts::options_description config_opts("Character service configuration options");
	config_opts.add(character::Service::options());
