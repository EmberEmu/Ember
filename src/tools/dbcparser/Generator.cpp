...
void generate_linker(const std::vector<types::Definition>& defs, const std::string& output) {
...
void generate_memory_defs(const std::vector<types::Definition>& defs, const std::string& output) {
