...
TEST(GruntProtocol, ClientLoginChallenge) {
	...
	auto ip = boost::asio::ip::make_address_v4("10.0.0.5").to_uint();
...
TEST(GruntProtocol, ClientReconnectProof) {
	...
	std::array<std::uint8_t, hash_sizes::sha160> r2_expected {
		0xc0, 0x4e, 0x35, 0xe6, 0xfe, 0xb2, 0x1a, 0x84,
	    0x98, 0xc4, 0x8e, 0x6c, 0x2d, 0x7f, 0x42, 0x56,
	    0xb6, 0x4c, 0x98, 0x24
	};

	std::array<std::uint8_t, hash_sizes::sha160> r3_expected {
		0x0d, 0xbe, 0x94, 0xaf, 0x7f, 0x46, 0x94, 0xa2,
